...
export class Backend implements backendInterface {
    ...
    async markSubmissionRead(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markSubmissionRead(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async markSubmissionUnread(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markSubmissionUnread(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitQuery(arg0: Submission): Promise<bigint> {
        if (this.processError) {
            try {
